---
title: "Flexible Dot Plot Tutorial"
...
devtools::install_local("path/to/FDP/folder")
...
```{r, eval=F}
# Same results
dot_plot(data.to.plot = PBMC3K_example_data, col_var = 4, , text.size = 3, shape.scale = 20)
dot_plot(data.to.plot = PBMC3K_example_data, col_var = PBMC3K_example_data$pct.exp2, , text.size = 3, shape.scale = 20)
```
...
final_plot <- grid.arrange(grob(), dotplot[[1]][[2]], dotplot[[1]][[3]], 
                           dotplot[[1]][[4]], ncol = 2, widths = c(1, 8), heights = c(1,8))
